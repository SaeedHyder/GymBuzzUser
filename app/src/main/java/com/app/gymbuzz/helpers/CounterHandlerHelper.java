...
public class CounterHandlerHelper {
        ...
        public CounterHandlerHelper(){

        }
        private CounterHandlerHelper(Builder builder) {
        ...
        public static final class Builder {
            ...
            public CounterHandlerHelper build() {
                return new CounterHandlerHelper(this);
            }
        }
}
