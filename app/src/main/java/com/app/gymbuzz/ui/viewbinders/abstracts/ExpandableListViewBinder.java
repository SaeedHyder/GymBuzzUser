package com.app.gymbuzz.ui.viewbinders.abstracts;
...
public abstract class ExpandableListViewBinder<T,E> {
     ...
     * @param activity
     */
    public abstract void bindGroupView(T entity, int position, int grpPosition, View view, Activity activity, boolean isExpanded);
    ...
    //public abstract void getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parentView);
