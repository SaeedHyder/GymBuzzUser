...
public class ArrayListExpandableAdapterOld<T, E> extends BaseExpandableListAdapter {
    ...
    public ArrayListExpandableAdapterOld(Activity context, ArrayList<T> headerCollection, HashMap<T, T> listDataChild,
