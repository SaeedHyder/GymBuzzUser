...
public class TitleBar extends RelativeLayout {
    ...
    private AnyTextView txtBtn;
    private AnyTextView btnHelp;
    private RelativeLayout containerRight2;
    ...
    private void bindViews() {
        ...
        txtBtn = (AnyTextView) findViewById(R.id.txtBtn);
        btnHelp = (AnyTextView) findViewById(R.id.btnHelp);
        containerRight2 = (RelativeLayout) findViewById(R.id.containerRight2);
    ...
    public void updateRightButton(int id) {
        btnRight.setImageResource(id);
    }

    public void showRight2Button(int id, OnClickListener onClickListener) {
        btnRight2.setVisibility(View.VISIBLE);
        btnRight2.setOnClickListener(onClickListener);
        btnRight2.setImageResource(id);
    }
    public void showCallForHelpButton(OnClickListener onClickListener) {
        btnHelp.setVisibility(View.VISIBLE);
        btnHelp.setOnClickListener(onClickListener);
    }

    public void showRightTextButton(String text, OnClickListener onClickListener) {
        btnRight.setVisibility(View.GONE);
        containerRight2.setVisibility(View.GONE);
