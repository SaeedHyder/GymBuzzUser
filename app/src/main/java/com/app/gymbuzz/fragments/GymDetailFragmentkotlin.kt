...
class GymDetailFragmentkotlin:BaseFragment(),ItemClickListener{
    ...
    companion object {
        val Tag: String = "GymDetailFragmentkotlin"
        fun newInstance(): GymDetailFragmentkotlin {
            val fragment = GymDetailFragmentkotlin()
            return fragment
        }
    }
